            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-5 col-12 mt-4">
                        ...
                        <p class="pb-sm-5">Lorem, ipsum dolor elit. Dolores assumenda voluptatem
                            placeat
                            necessitatibus tenetur, amet, eum repelque a suscipit temporibus esse velit
                            cupiditate animi is quis!</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Javascript</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-js.jpeg"
                        ...
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>PHP</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-php.jpg"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>HTML5</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-html5.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>React.js</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-react.js.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>jQuery</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-jquery.jpg"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Bootstrap</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-bootstrap.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Laravel</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-laravel.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>MySQL</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-mysql.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>CSS</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-css.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Git</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-git.png"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Apache</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-apache.jpg"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                        <div class="col-sm-2 col-6 text-center">
                            <div class="px-4 py-5 mx-0 card">
                                <h3>Mercadopago</h3>
                                <img class="mx-auto d-block img-fluid" width="60" src="imagenes/icon-mp.jpg"
                                    alt="Javascript" title="Javascript">
                            </div>
                        </div>
                    </div>
